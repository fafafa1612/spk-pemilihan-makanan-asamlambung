...
<body class="bg-gradient-light ">
    <nav class="navbar navbar-expand-lg navbar-dark bg-light shadow-lg pb-3 pt-3 font-weight-bold bg-navbar">
        <div class="container">
            <a class="navbar-brand text-danger" style="font-weight: 900;" href="login.php"> 
            <i class="fa-solid fa-apple-whole fa-rotate-by" style = "--fa-rotate-angle: 40deg;"></i> SPK Pemilihan Makanan</a>
        </div>
    </nav>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0">
                        <H1>Selamat datang di Website SPK Pemilihan Makanan <h2><br>Website ini dapat membantu anda Memilih Makanan pada saat Asam Lambung menyerang, sesuai dengan Kondisi anda.</h2></H1>    
                    </div>
                </div>
            </div>
