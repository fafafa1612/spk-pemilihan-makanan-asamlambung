...
?>
    ...
    <div class="mb-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fa-solid fa-house-chimney-user"></i> Dashboard</h1>
        </div>
                    ...
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <i class="fa-solid fa-stroopwafel fa-2x text-blue-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-secondary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <i class="fa-regular fa-lemon fa-2x text-darkblue-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-green shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                <i class="fa-solid fa-bowl-food fa-2x text-darkgreen-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <i class="fas fa-edit fa-2x text-blue-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <i class="fas fa-calculator fa-2x text-darkblue-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-green shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <i class="fas fa-chart-area fa-2x text-darkgreen-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
