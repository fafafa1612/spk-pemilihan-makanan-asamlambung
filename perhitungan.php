...
<div class="select">
	...
	<label for="pages">Pilih:</label>
        <select name="data" id="data" class = "select-control">
            <option value="dataalternatif">Data Penilaian Alternatif</option>
            <option value="datanorma">Data Normalisasi</option>
			<option value="dataper">Data Perhitungan</option>
        </select>
        <button type="submit" class = "style-button"><i class="fa fa-print"></i>Cetak Data</button>
	</form>
</div>
	...
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> Bobot</h6>
		</div>
	...
	<div class="card shadow mb-4">
		<!-- /.card-header -->
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> Matrix Penilaian Alternatif </h6>
		</div>
	...
	<div class="card shadow mb-4">
		<!-- /.card-header -->
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> Data Normalisasi</h6>
		</div>
	...
	<div class="card shadow mb-4">
		<!-- /.card-header -->
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> Data Perhitungan </h6>
		</div>
